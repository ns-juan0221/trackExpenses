...
<div class="container-fluid flex-grow-1">
    <div class="routeDisplay w-100">
        <p class="ms-2 p-1">
            <a href="{{ route('redirectMain') }}">ホーム</a>  ->  <a href="{{ route('redirectSearch') }}">検索画面</a>
        </p>
    </div>
    <div class="searchBox">
                            ...
                            <td class="categoryInput">
                                <div class="formUnit d-flex flex-column">
                                    ...
                                    <div class="categorySelectBtn w-100">
                                        ...
                                        <button type="button" class="btn btn-outline-success" onclick="clearSelection()">選択をクリア</button>
                                    </div>
