...
@section('content')
    ...
    <div class="container-fluid flex-grow-1">
        <div class="mainArticle justify-content-center">
            <div class="createForm mt-4">
                ...
                <div class="createBox p-2">
                    <form action="{{ route('store') }}" class="formContainer needs-validation" method="post">
                        ...
                        <div class="formGroupBlock w-100">
                            ...
                            @if($type === 'income')
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" name="amount" id="inputAmount" class="form-control mb-2" placeholder="半角数字で入力" value="{{ $errors->has('amount') ? '' : old('amount') }}" required autocomplete="off">
                                    ...
                                    @foreach (old('item', ['']) as $index => $oldItem)
                                        <div class="formList d-flex flex-column">
                                            <div class="inputList mb-2 d-flex flex-row">
                                                <div class="form-group form-item me-1">
                                                ...
                                                <div class="form-group form-category me-1">
                                                ...
                                                <div class="form-group form-price me-1">
                                                ...
                                                <div class="form-group form-amount me-1">
                                                ...
                                                <!-- 削除ボタン -->
                                                <button type="button" class="btn btn-danger remove-form">✖︎</button>
                                            </div>
                                            <div class="errorList">
    ...
    @else
        <script src="{{ asset('js/outcomeFormForRegister.js')}}"></script>
    @endif
@endsection